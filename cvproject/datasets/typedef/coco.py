...
from cvproject.shapes.typedef.bboxes import BBoxCocoType
from cvproject.shapes.typedef.polys import PolysCocoType
from cvproject.shapes.typedef.rles import RLEsType, RLEType
