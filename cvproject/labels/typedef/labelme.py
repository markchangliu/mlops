...
from cvproject.shapes.typedef.bboxes import BBoxLabelmeType
from cvproject.shapes.typedef.polys import PolyLabelmeType
from cvproject.shapes.typedef.rles import RLEType
from cvproject.shapes.typedef.contours import ContourType
